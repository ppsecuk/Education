...
public class CarAndBikeExercise {
    public static void main(String[] args) {
/*        Process for homework:
1. Create in Java
2. Unit test
3. Push to GIT
4. Send GIT LINK to Evgeni (until Friday 15.00)
 ...
 HOMEWORK:* Let’s buy a vehicle
        ...
        e. User will provide all of the details about the Person (buyer) using command-line (e.g.
                “John Smith born 3/24/1984”. Provided information will be parsed using Regex within Parser
        class. Parser class should receive char sequence and return an object of type Person or Null if provided details
